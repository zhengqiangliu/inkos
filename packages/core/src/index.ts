...
export { countAuditIssueClasses, resolvePrimaryIssueClass, classifyAuditIssueClass, isStructuralAuditIssue, estimateAuditScoreDetailed, AUDIT_SCORE_DEDUCTION, type AuditIssueClass, type AuditIssueClassCounts, type AuditIssueSignalSource, type ScorableAuditIssue } from "./utils/audit-issue-classification.js";
