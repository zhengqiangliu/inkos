...
const strings = {
  ...
  "book.openExport": { zh: "打开文件", en: "Open File" },
  "book.exportSaved": { zh: "导出成功", en: "Export completed" },
  "book.exportOpenFailed": { zh: "无法打开导出的文件", en: "Could not open the exported file" },
  "book.exportSaveFailed": { zh: "导出失败", en: "Export failed" },
